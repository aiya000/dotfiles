...
-- WPF
vim.list_extend(method_snippets, sm({"messagebox_wpf", "msgbox_wpf"}, {
    t("MessageBox.Show("), i(1, "#:text"), t(", "), i(2, "#:caption"), t(", MessageBoxButton."), i(3, "OK"), t(", MessageBoxImage."), i(4, "Information"), t(");"), i(5, "")
  }))

vim.list_extend(method_snippets, sm({"messagebox_yesno_wpf", "msgbox_yesno_wpf"}, {
