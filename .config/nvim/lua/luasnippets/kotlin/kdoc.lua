...
vim.list_extend(kdoc_snippets, sm({'kdoc_comment_block', 'document_comment_block', 'doc'}, fmt([[
  /**
   * {content}
   */
]], {
...
vim.list_extend(kdoc_snippets, sm({'kdoc_param', 'param'}, fmt([[
...
vim.list_extend(kdoc_snippets, sm({'kdoc_see', 'see'}, fmt([[
  @see {identifier}
]], {
  identifier = i(1, 'identifier'),
})))

vim.list_extend(kdoc_snippets, sm({'kdoc_throws', 'throws'}, fmt([[
