...
local kotlin_snippets = list.concat(
  ...
  sm(
    { 'print_error_line', 'print_errror_ln', 'err_println' },
    fmt(
      [[
  ...
  sm(
    { 'class', 'cla', 'class_without_constructor' },
    fmt(
      [[
    class {name} {{{body}}}
  ]],
  ...
  sm(
    { 'import_as', 'import_qualified', 'imq' },
    fmt(
      [[
  ...
  sm(
    { 'anonymous_class_instance', 'object_anonymous_instance' },
    fmt(
      [[
    object : {parent} {{{body}}}
  ]],
  ...
  s(
    'constructor_delegate_to_parent',
    fmt(
      [[
  ...
  sm(
    { 'throw_runtime_exception_as_fatal_error', 'fatal_error' },
    fmt(
      [[
  ...
  sm(
    { 'launch', 'async_block_without_returning_a_value' },
    fmt(
      [[
    launch {{{body}}}
  ]],
  ...
  sm(
    { 'async', 'async_block_with_returning_a_value' },
    fmt(
      [[
    async {{{body}}}
  ]],
  ...
  sm(
    { 'runBlocking', 'run_async_operations' },
    fmt(
      [[
    runBlocking {{{body}}}
  ]],
  ...
  -- Others
  sm(
    { 'define_sum_types', 'sum_types', 'declare_sum_types' },
    fmt(
      [[
