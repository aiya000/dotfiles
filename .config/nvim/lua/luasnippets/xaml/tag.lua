...
local M = {
  ...
  s('Grid_ColumnDefinitionsSurrond', {
    t('<Grid.ColumnDefinitions>'),
    i(0),
    t('</Grid.ColumnDefinitions>'),
  }),

  s('Grid_RowDefinitionsSurrond', {
    t('<Grid.RowDefinitions>'),
    i(0),
    t('</Grid.RowDefinitions>'),
  }),
  ...
  s('ResourceDictionary_MergedDictionaries', {
    t('<ResourceDictionary.MergedDictionaries>'),
    i(0),
    t('</ResourceDictionary.MergedDictionaries>'),
  }),
...
<Window x:Class="{}"
  ...
  s('Interaction_Triggers_surround_template', {
    ...
    t('    <'),
    i(1),
    t(':EventTrigger EventName="'),
    i(2, 'Click'),
    t('">'),
    t('\n'),
    t('        <'),
    i(1),
    t(':InvokeCommandAction Command="{Binding '),
    i(3, 'An_ICommand'),
    t('}"/>'),
    t('\n'),
    t('    </'),
