...
local java_snippets = list.concat(
  ...
  sm({'for_with_index', 'for_traditional'}, fmt([[
  ...
  sm({'private_function', 'prifun'}, fmt([[
  ...
  sm({'annoration_suppress_warnings', 'suppress_warnings'}, fmt([[
