...
-- Components
local nativescript_flexbox_layout_snippets = sm(
  'nativescript_flexbox_layout',
  { 'ns_flexbox_layout', 'flexbox_layout', 'FlexboxLayout' },
  s(
    'nativescript_flexbox_layout',
...
local nativescript_stack_layout_snippets = sm(
  'nativescript_stack_layout',
  { 'ns_stack_layout', 'stack_layout', 'StackLayout' },
  s(
    'nativescript_stack_layout',
...
local nativescript_absolute_layout_snippets = sm(
  'nativescript_absolute_layout',
  { 'ns_absolute_layout', 'absolute_layout', 'AbsoluteLayout' },
  s(
    'nativescript_absolute_layout',
...
local nativescript_scroll_view_snippets = sm(
  'nativescript_scroll_view',
  { 'ns_scroll_view', 'scroll_view', 'ScrollView' },
  s(
    'nativescript_scroll_view',
...
local nativescript_label_snippets = sm(
  'nativescript_label',
  { 'ns_label' },
  s(
    'nativescript_label',
...
local nativescript_button_snippets = sm(
  'nativescript_button',
  { 'ns_button' },
  s(
    'nativescript_button',
...
local nativescript_image_snippets = sm(
  'nativescript_image',
  { 'ns_image' },
  s(
    'nativescript_image',
...
local nativescript_align_items_center_snippets = sm(
  'nativescript_align_items_center',
  { 'ns_align_items_center' },
  s('nativescript_align_items_center', t('alignItems="center"'))
)
