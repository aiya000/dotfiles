...
local folding_without_folding_snippets = sm(
  'folding_without_folding',
  { 'details_summary_without_folding' },
  s('folding_without_folding', {
    t({ '<details>', '<summary>' }),
    i(1, 'summary'),
    t({ '</summary>', '' }),
    i(2, ''),
...
local revealjs_speaker_notes_snippets = sm(
  'revealjs_speaker_notes',
  { 'speaker_notes' },
  s(
    'revealjs_speaker_notes',
