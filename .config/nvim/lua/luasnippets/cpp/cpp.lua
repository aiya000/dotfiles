...
vim.list_extend(
  cpp_snippets,
  sm(
    { 'do_demangle', 'lets_demangle', 'demangle_template' },
    fmt(
      [[
...
vim.list_extend(
  cpp_snippets,
  sm(
    { 'get_type_of_exception_ptr', 'exception_ptr_type' },
    fmt(
      [[
...
vim.list_extend(
  cpp_snippets,
  sm(
    { 'unique_resource', 'scoped_resource', 'scoped_guard', 'finally' },
    fmt(
      [[
/*!
