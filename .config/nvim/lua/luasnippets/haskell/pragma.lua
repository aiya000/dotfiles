...
vim.list_extend(
  pragma_snippets,
  sm({ 'pragma_inline', 'inline' }, { t('{-# INLINE '), i(0, 'funcName'), t(' #-}') }, { key = 'pragma_inline' })
)
...
vim.list_extend(
  pragma_snippets,
  sm({ 'pragma_language' }, { t('{-# LANGUAGE '), i(1), t(' #-}') }, { key = 'pragma_language' })
)
...
table.insert(
  pragma_snippets,
  s('pragma_language_generalized_newtype_deriving', t('{-# LANGUAGE GeneralizedNewtypeDeriving #-}'))
)
table.insert(
  pragma_snippets,
  s('pragma_language_functional_dependencies', t('{-# LANGUAGE FunctionalDependencies #-}'))
)
table.insert(
  pragma_snippets,
  s('pragma_language_multi_param_type_classes', t('{-# LANGUAGE MultiParamTypeClasses #-}'))
)
table.insert(pragma_snippets, s('pragma_language_flexible_contexts', t('{-# LANGUAGE FlexibleContexts #-}')))
table.insert(
  pragma_snippets,
  s('pragma_language_existential_quantification', t('{-# LANGUAGE ExistentialQuantification #-}'))
)
...
table.insert(
  pragma_snippets,
  s('pragma_language_constrained_class_methods', t('{-# LANGUAGE ConstrainedClassMethods #-}'))
)
