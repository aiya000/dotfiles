...
-- Syntaxes
local class_snippets = sm("class", {"cla", "cl", "scss_class"}, s("class",
  fmt([[.{} {{{}}}]], {
    i(1, "name"),
    i(2, "#:here")
  })
...
M.regex_wildcard = s("regex_wildcard",
  fmt([[[{}*='{}'] {{{}}}]], {
    i(1, "class"),
    i(2, "heading"),
    i(3, "#:here")
...
-- Templates
M.media_query_tablet = s("media_query_tablet",
  fmt([[@media screen and (max-width: 1024px) {{{}}}]], {
    i(1, "#:here")
  })
)

M.media_query_mobile = s("media_query_mobile",
...
M.flex_direction = s("flex_direction",
  fmt([[flex-direction: {};]], {
    i(1, "column")
  })
)

M.justify_content = s("justify_content",
  fmt([[justify-content: {};]], {
    i(1, "center")
  })
)

M.align_items = s("align_items",
  fmt([[align-items: {};]], {
    i(1, "center")
  })
)

M.align_self = s("align_self",
  fmt([[align-self: {};]], {
    i(1, "center")
  })
)
