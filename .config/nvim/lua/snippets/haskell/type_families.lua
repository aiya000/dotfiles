...
vim.list_extend(type_families_snippets, sm(
  {"type_family", "type_func_declare"},
  t("type family"),
  {key = "type_family"}
))
...
vim.list_extend(type_families_snippets, sm(
  {"type_family_gadts", "type_func_declare_gadts"},
  {
    t("type family "), i(1, "#:TypeName"), t(" "), i(2, "a"), t(" where"), t({"", "    "}),
    i(1), t(" = "), i(0)
  },
...
vim.list_extend(type_families_snippets, sm(
  {"type_family_gadts_kind", "type_func_define_gadts_kind"},
  {
    t("type family "), i(1, "#:TypeName"), t(" "), i(2, "a"), t(" :: "), i(3, "*"), t(" where"), t({"", "    "}),
    i(1), t(" "), i(4, "#:args"), t(" = "), i(0)
  },
