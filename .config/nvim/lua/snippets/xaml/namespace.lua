...
local M = {
  ...
  s('declare_xml_clr_namespace', {
    t('xmlns:'), i(1, 'nameSpaceName'), t('="clr-namespace:'), i(2, 'NameSpacePath'), t('"')
  }),

  s('declare_xml_clr_namespace_with_assembly', {
    t('xmlns:'), i(1, 'nameSpaceName'), t('="clr-namespace:'), i(2, 'NameSpacePath'), t(';assembly='), i(3, 'AssemblyNameSpace'), t('"')
  }),
  ...
  s('declare_xml_ewpf_namespace', {
    t('xmlns:'), i(1, 'xctk'), t('="http://schemas.xceed.com/wpf/xaml/toolkit"')
  }),
}
