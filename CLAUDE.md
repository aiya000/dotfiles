...
<!--
Note for me (a user):
This is not a global instruction file.
(This is a custom instruction file just for Claude Code and dotfiles repository.)
Use '~/.dotfiles/ai-custom-instructions.md' instead if you needed.
-->
