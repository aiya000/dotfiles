function! vimrc#dein#hook_source#gina() abort
    ...
    call gina#custom#mapping#nmap('status' , 'cc'    , ':<C-u>tabnew<CR>:Gina commit --verbose<CR>'             , {'noremap': 1 , 'silent': 1})
    call gina#custom#mapping#nmap('status' , 'ca'    , ':<C-u>tabnew<CR>:Gina commit --verbose --amend<CR>'     , {'noremap': 1 , 'silent': 1})
