...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_vimrc#Math#import() abort
    return map({'sum': '', 'gcd': '', 'nr2str': '', 'fib': '', 'str2nr': '', 'lcm': '', 'round': '', 'modulo': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_vimrc#Math#import() abort', printf("return map({'sum': '', 'gcd': '', 'nr2str': '', 'fib': '', 'str2nr': '', 'lcm': '', 'round': '', 'modulo': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
" math utilities.
