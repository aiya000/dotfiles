...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_vimrc#Data#Optional#import() abort
  ...
  execute join(['function! vital#_vimrc#Data#Optional#import() abort', printf("return map({'flatten': '', 'some': '', 'apply': '', 'none': '', 'get_unsafe': '', 'is_optional': '', 'echo': '', 'exists': '', 'map': '', 'empty': '', 'get': '', 'has': '', 'unset': '', 'bind': '', 'get_or': '', 'set': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
