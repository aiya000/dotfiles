...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_vimrc#Data#Closure#import() abort
    return map({'from_funcname': '', 'from_funcref': '', 'from_expr': '', 'from_operator': '', 'build': '', 'from_method': '', 'apply': '', 'is_callable': '', 'call': '', 'sweep_functions': '', 'from_command': '', 'is_binding_supported': '', 'is_closure': '', 'compose': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_vimrc#Data#Closure#import() abort', printf("return map({'from_funcname': '', 'from_funcref': '', 'from_expr': '', 'from_operator': '', 'build': '', 'from_method': '', 'apply': '', 'is_callable': '', 'call': '', 'sweep_functions': '', 'from_command': '', 'is_binding_supported': '', 'is_closure': '', 'compose': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
