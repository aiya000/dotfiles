...
execute join(['function! vital#_vimrc#Data#Closure#import() abort', printf("return map({'from_funcname': '', 'from_funcref': '', 'from_expr': '', 'from_operator': '', 'build': '', 'from_method': '', 'apply': '', 'is_callable': '', 'call': '', 'sweep_functions': '', 'from_command': '', 'is_binding_supported': '', 'is_closure': '', 'compose': ''}, \"vital#_vimrc#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
