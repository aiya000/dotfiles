...
nnoremap <buffer><silent> cc :<C-u>tabnew<CR>:Gina commit --verbose<CR>:w<CR>:only<CR>ggO
nnoremap <buffer><silent> ca :<C-u>tabnew<CR>:Gina commit --verbose --amend<CR>gg0:only<CR>
