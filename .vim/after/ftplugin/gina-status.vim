...
nnoremap <buffer><silent> cc :<C-u>q<CR>:tabnew \| terminal git commit --verbose \| only<CR>
nnoremap <buffer><silent> ca :<C-u>q<CR>:tabnew \| terminal git commit --verbose --amend \| only<CR>
